from characters import Pig,Static_block
from shapes import Polygon


class Level():
    def __init__(self, pigs, columns, beams, static_block, space):
        self.pigs = pigs
    ...
    def build_1(self):
        """level 1"""
        static_block1 = Static_block(704,650-512,52,150,self.space)
        ...
        self.pigs.append(pig)
        pig = Pig(837, 650 - 527, self.space)
        self.pigs.append(pig)
        pig = Pig(867, 650 - 527, self.space)
        self.pigs.append(pig)
        pig = Pig(897, 650 - 527, self.space)
        self.pigs.append(pig)
        pig = Pig(927, 650 - 527, self.space)
        self.pigs.append(pig)
        pig = Pig(957, 650 - 527, self.space)
        self.pigs.append(pig)
    ...
    def build_4(self):
        """level 4"""
        pig = Pig(900-30, 330, self.space)
        self.pigs.append(pig)
        pig = Pig(1000-30, 550, self.space)
        self.pigs.append(pig)
        pig = Pig(1100-30, 450, self.space)
        self.pigs.append(pig)
        pig = Pig(900, 350, self.space)
        self.pigs.append(pig)
        pig = Pig(1000, 200, self.space)
        self.pigs.append(pig)
    ...
    def build_6(self):
        ...
        self.pigs.append(pig)
        pig = Pig(920+30, 633, self.space)
        self.pigs.append(pig)
        pig = Pig(920 + 70, 633, self.space)
        self.pigs.append(pig)
        pig = Pig(920-30, 633, self.space)
        self.pigs.append(pig)
        pig = Pig(720+30, 633, self.space)
        self.pigs.append(pig)
        pig = Pig(720-30, 633, self.space)
        self.pigs.append(pig)
        pig = Pig(720 - 70, 633, self.space)
        self.pigs.append(pig)
    ...
    def build_9(self):
        ...
        pig.life = 20
        self.pigs.append(pig)
        pig = Pig(800, 180, self.space)
        pig.life = 20
        self.pigs.append(pig)
        pig = Pig(1100, 180, self.space)
        pig.life = 20
        self.pigs.append(pig)
        pig = Pig(900, 280, self.space)
        pig.life = 20
        self.pigs.append(pig)
        pig = Pig(1000, 280, self.space)
        pig.life = 20
        self.pigs.append(pig)
        pig = Pig(1100, 280, self.space)
        pig.life = 20
        self.pigs.append(pig)
        self.open_flat(1050, 0, 3)
        self.open_flat(963, 0, 2)
    ...
    def build_11(self):
        """level 11"""
        static_block1 = Static_block(545, 650 - 490, 41, 150, self.space)
        static_block2 = Static_block(652, 650 - 490, 41, 150, self.space)
        static_block3 = Static_block(892, 650 - 490, 41, 150, self.space)
        static_block4 = Static_block(1000, 650 - 490, 41, 150, self.space)
        self.static_block.append(static_block1)
        self.static_block.append(static_block2)
        self.static_block.append(static_block3)
        self.static_block.append(static_block4)
        pig = Pig(606, 650-527, self.space)
        self.pigs.append(pig)
        pig = Pig(635, 650-527, self.space)
        self.pigs.append(pig)
        pig = Pig(955, 650-527, self.space)
        self.pigs.append(pig)
        pig = Pig(983, 650-527, self.space)
        self.pigs.append(pig)
        self.number_of_birds = 4
